---
--- This file is taken from https://github.com/overextended/oxmysql/blob/main/lib/MySQL.lua
--- All sources goes to oxmysql
--- https://github.com/overextended/oxmysql/
--- GNU Lesser General Public License license (see LICENSE)
---

-- lib/OXMySQL.lua provides complete compatibility for resources designed for mysql-async
...
local alias_mt = {
	__index = function(self, key)
		if alias[key] then
			OXMySQL.Async[key] = OXMySQL[alias[key]]
			OXMySQL.Sync[key] = OXMySQL[alias[key]].await
			alias[key] = nil
			return self[key]
		end
	end
...
setmetatable(OXMySQL.Async, alias_mt)
setmetatable(OXMySQL.Sync, alias_mt)

_ENV.OXMySQL = OXMySQL
